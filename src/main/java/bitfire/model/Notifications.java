...
//		SendGrid sg = new SendGrid(System.getenv("SendGridKey"));
	...
	public static void SendInvoice(String toEmail, String toName, String fromEmail, String fromName, String amount,
		...
		content.setValue(
				...
				+ "					</div>"
				+ "					<a style='display: block;max-width: 100px; color: #ffffff;background: rgb(247,97,22); padding: 10px 15px; margin-top:10px; border-radius: 5px; text-decoration: none; text-align:center; font-weight:bold;' href = 'https://bitfi.re/user/send.html" + "?to=" + fromEmail + "&amount=" + amount + "'>Pay</a><br>"
				+ "					<p>Sincerely,</p>"
				+ "					<p>Team Bitfire</p>"
				+ "				</div>" 
				+ "			</div>"
